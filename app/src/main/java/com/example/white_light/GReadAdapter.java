...
public class GReadAdapter extends RecyclerView.Adapter<com.example.white_light.GAdapter.MyViewHolder> {
    //create variables from java classes
    private GReadShowActivity activity;
    private List<GModel> mList;

    private FirebaseFirestore db = FirebaseFirestore.getInstance();

    public GReadAdapter(GReadShowActivity activity , List<GModel> mList){//overloaded constructor
    ...
    @NonNull
    @Override
    public com.example.white_light.GAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(activity).inflate(R.layout.gartitem , parent , false);
        return new com.example.white_light.GAdapter.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.white_light.GAdapter.MyViewHolder holder, int position) {
